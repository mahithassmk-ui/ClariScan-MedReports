...
const {
  ...
  parseVaryHeader,
  isEtagUsable
} = require('undici/lib/util/cache.js')
const { parseHttpDate } = require('undici/lib/util/date.ts')
...
/**
 * @typedef {import('undici/types/dispatcher').default.DispatchHandler} DispatchHandler
 *
...
class CacheHandler {
  ...
  /**
   * @type {import('undici/types/cache-interceptor').default.CacheHandlerOptions['type']}
   */
  #cacheType
  ...
  /**
   * @type {import('undici/types/cache-interceptor').default.CacheStore}
   */
  #store

  /**
   * @type {import('undici/types/dispatcher').default.DispatchHandler}
   */
  #handler
  ...
  /**
   * @param {import('undici/types/cache-interceptor').default.CacheHandlerOptions} opts
  ...
  /**
   * @param {import('undici/types/dispatcher').default.DispatchController} controller
   * @param {number} statusCode
   * @param {import('undici/types/header').IncomingHttpHeaders} resHeaders
  ...
  onResponseStart (
    ...
    /**
     * @type {import('undici/types/cache-interceptor').default.CacheValue}
     */
    const value = {
      statusCode,
      statusMessage,
 ...
 *
 * @param {import('undici/types/cache-interceptor').default.CacheOptions['type']} cacheType
 * @param {number} statusCode
 * @param {import('undici/types/header').IncomingHttpHeaders} resHeaders
 * @param {import('undici/types/cache-interceptor').default.CacheControlDirectives} cacheControlDirectives
 */
