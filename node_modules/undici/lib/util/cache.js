...
} = require('undici/lib/core/util.js')

const { serializePathWithQuery } = require('undici/lib/core/util.js')

/**
 * @param {import('undici/types/dispatcher').default.DispatchOptions} opts
 */
 ...
 * @returns {import('undici/types/cache-interceptor').default.CacheControlDirectives}
 */
function parseCacheControlHeader (header) {
  /**
   * @type {import('undici/types/cache-interceptor').default.CacheControlDirectives}
   */
  const output = {}
...
/**
 * @param {unknown} store
 * @returns {asserts store is import('undici/types/cache-interceptor').default.CacheStore}
 */
 ...
 * @returns {asserts methods is import('undici/types/cache-interceptor').default.CacheMethods[]}
 */
