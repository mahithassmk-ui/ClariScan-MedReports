...
const DeduplicationHandler = require('undici/lib/handler/deduplication-handler.js')
const { normalizeHeaders, makeCacheKey, makeDeduplicationKey } = require('undici/lib/util/cache.js')

const pendingRequestsChannel = diagnosticsChannel.channel('undici:request:pending-requests')

/**
 * @param {import('undici/types/interceptors').default.DeduplicateInterceptorOpts} [opts]
