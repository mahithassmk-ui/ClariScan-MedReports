...
const CacheHandler = require('undici/lib/handler/cache-handler.js')
const MemoryCacheStore = require('undici/lib/cache/memory-cache-store.js')
const CacheRevalidationHandler = require('undici/lib/handler/cache-revalidation-handler.js')
...
/**
 * @typedef {(options: import('undici/types/dispatcher').default.DispatchOptions, handler: import('undici/types/dispatcher').default.DispatchHandler) => void} DispatchFn
 */

/**
 * @param {import('undici/types/cache-interceptor').default.GetResult} result
 * @param {import('undici/types/cache-interceptor').default.CacheControlDirectives | undefined} cacheControlDirectives
 * @param {import('undici/types/dispatcher').default.RequestOptions} opts
 * @returns {boolean}
 */
 ...
 * @param {import('undici/types/cache-interceptor').default.CacheHandlerOptions} globalOpts
 * @param {import('undici/types/cache-interceptor').default.CacheKey} cacheKey
 * @param {import('undici/types/dispatcher').default.DispatchHandler} handler
 * @param {import('undici/types/dispatcher').default.RequestOptions} opts
 * @param {import('undici/types/cache-interceptor').default.CacheControlDirectives | undefined} reqCacheControl
 */
 ...
 * @param {import('undici/types/dispatcher').default.RequestOptions} opts
 * @param {import('undici/types/cache-interceptor').default.CacheControlDirectives | undefined} reqCacheControl
 * @param {import('undici/types/cache-interceptor').default.GetResult | undefined} result
 */
...
/**
 * @param {import('undici/types/cache-interceptor').default.CacheOptions} [opts]
 * @returns {import('undici/types/dispatcher').default.DispatcherComposeInterceptor}
 */
module.exports = (opts = {}) => {
  const {
  ...
  return dispatch => {
    return (opts, handler) => {
      ...
      /**
       * @type {import('undici/types/cache-interceptor').default.CacheKey}
       */
