...
const { collectAnHTTPQuotedString, parseMIMEType } = require('undici/lib/web/fetch/data-url')
...
const { isomorphicEncode, collectASequenceOfCodePoints, removeChars } = require('undici/lib/web/infra')
