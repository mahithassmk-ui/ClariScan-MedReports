...
const {
  ...
  fullyReadBody,
  extractMimeType
} = require('undici/lib/web/fetch/util.js')
const { FormData, setFormDataState } = require('undici/lib/web/fetch/formdata.js')
const { webidl } = require('undici/lib/web/webidl/index.js')
const assert = require('node:assert')
const { isErrored, isDisturbed } = require('node:stream')
const { isUint8Array } = require('node:util/types')
const { serializeAMimeType } = require('undici/lib/web/fetch/data-url.js')
const { multipartFormDataParser } = require('undici/lib/web/fetch/formdata-parser.js')
const { createDeferredPromise } = require('undici/lib/util/promise.js')
const { parseJSONFromBytes } = require('undici/lib/web/infra/index.js')
const { utf8DecodeBytes } = require('undici/lib/encoding/index.js')
const { runtimeFeatures } = require('undici/lib/util/runtime-features.js')
 ...
 *
 * @param {import('undici/types/index.js').BodyInit} object - The BodyInit object to extract from
...
function bodyMimeType (requestOrResponse) {
  ...
  /** @type {import('undici/lib/web/fetch/headers.js').HeadersList} */
