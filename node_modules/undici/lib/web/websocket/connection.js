...
const { parseExtensions, isClosed, isClosing, isEstablished, isConnecting, validateCloseCodeAndReason } = require('undici/lib/web/websocket/util')
...
const { runtimeFeatures } = require('undici/lib/util/runtime-features')
