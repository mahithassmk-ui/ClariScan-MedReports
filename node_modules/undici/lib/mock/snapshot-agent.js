...
class SnapshotAgent extends MockAgent {
   ...
   * @param {Array<{hash: string; snapshot: import('undici/lib/mock/snapshot-recorder').SnapshotEntryshotEntry}>|Record<string, import('undici/lib/mock/snapshot-recorder').SnapshotEntry>} snapshotData - New snapshot data to replace existing snapshots
   * @returns {void}
   */
